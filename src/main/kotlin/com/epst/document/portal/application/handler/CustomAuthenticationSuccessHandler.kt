...
import com.epst.document.portal.core.service.AuthenticationService
...
class CustomAuthenticationSuccessHandler(private val authenticationService: AuthenticationService): SimpleUrlAuthenticationSuccessHandler() {
    ...
    override fun onAuthenticationSuccess(request: HttpServletRequest,
        ...
        val token = (authentication.principal as com.epst.document.portal.common.util.User).email
