...
import com.epst.document.epstportal.common.util.Constant.Companion.CURRENT_DATE
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_SLUG
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_SLUG_AUTHENTICATE_DOCUMENT
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_SLUG_DOWNLOAD_CERTIFICATE
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_SLUG_VERIFY_RESULT
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_TITLE
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_TITLE_AUTHENTICATE_DOCUMENT
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_TITLE_DOWNLOAD_CERTIFICATE
import com.epst.document.epstportal.common.util.Constant.Companion.PAGE_TITLE_VERIFY_RESULT
import com.epst.document.epstportal.common.util.Constant.Companion.QR_CODE
import com.epst.document.epstportal.common.util.Constant.Companion.RESULT_EXETAT
...
class CheckingController(private val checkingService: CheckingService,
    ...
    private fun getServerDoaminName(request: HttpServletRequest) : String{
        val domain = URL(request?.requestURL.toString()).host
    ...
    fun getPDF(@SessionAttribute(RESULT_EXETAT) result : ResultExetat, request: HttpServletRequest, response: HttpServletResponse): ResponseEntity<*>? {
        ...
        val qrCodeData = "${getServerDoaminName(request)}/authenticate-document?code=${result.cdCdt}"


        val imgQrCode = qrCodeService.generateQRCode(qrCodeData)
